...
xdata stSpeaker sSpeakerInfo;
xdata tUINT8   sIsEmergencyAlarm;	///< flag for auto repeat alarm when the alarm count to 0
...
static vConfigSpeakerHW( tUINT16 argFreq )
{	
